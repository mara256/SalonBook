...
{
    public partial class AdaugaRecenzii : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comentariu = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recenzii_Saloane_SalonId",
                        column: x => x.SalonId,
